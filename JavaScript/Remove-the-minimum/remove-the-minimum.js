//URL to Challenge: https://www.codewars.com/kata/563cf89eb4747c5fb100001b/train/javascript
...
function removeSmallest(numbers) {
    if(numbers.length > 0){
        smallest = numbers[0]
        for(x in numbers){
            document.getElementById("main").innerHTML += x + ": " + numbers[x] + "<br>";
            if(numbers[x] < smallest){
                smallest = numbers[x];
            }
        }
        var index = numbers.findIndex(find);
...
window.onload = removeSmallest([2,2,1,2,1]);